/**
 * ============================================================
 * SCRIPT 2 of 3 — MASTER DB SLIDE CREATOR
 * ============================================================
 ...
 *
 * What it does:
 *   - Receives project data + photos (base64) from Streamlit app.py
 *   - Opens Firebean_CaseStudy_Template Google Slides
 *   - Duplicates template slides 1+2 to end of presentation
 *   - Inserts photos into 2x3 grid on cover slide
 *   - Inserts white logo PNG onto cover slide
 *   - Fills all text placeholders (client, project, venue, date, scope)
 *   - Updates Master DB col M (Google Slide) with the slide URL
 *
